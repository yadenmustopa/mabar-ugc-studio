...
export const mabarApi = {
  ...
  setCompleteItem: async (ugcId: string | number, itemId: string | number, generateUrl: string) => {
    return axios.post(`${API_BASE_URL}/ugc/${ugcId}/item/${itemId}/complete`, { generate_url: generateUrl }, { headers: getHeaders() });
  },
